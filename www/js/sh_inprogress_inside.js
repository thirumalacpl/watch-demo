...
$('.document_imag_inproone_newccc').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneo+'two');
$('.document_imag_inproone_newddd').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
$('.document_imag_inproone_newbbb').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
$('.document_imag_inproone_newaaa').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
$('.document_imag_inproone_neweee').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
$('.document_imag_inproone_newfff').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 0){
  var one=oneemp[j];
//alert(one+'one');
$('.document_imag_inproone_newbbb').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 2){
  var oneoo=oneemp[j];
//alert(oneoo+'3');
$('.document_imag_inproone_newccc').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
$('.document_imag_inproone_newbbb').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.document_imag_inproone_newddd').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.document_imag_inproone_newccc').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.document_imag_inproone_newdaaa').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.document_imag_inproone_neweee').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.document_imag_inproone_newfff').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
