...
$(document).off('click', '#dashcooinectccrre').on('click', '#dashcooinectccrre', function() {

  $.mobile.changePage($('#dashboard_sh'), { transition: "none", changeHash: true, reverse: false });
return false;
});

  $(document).off('click', '#newshectccrr').on('click', '#newshectccrr', function() {
...
return false;
 ...
 $(document).off('click', '#inprogresscooinpp').on('click', '#inprogresscooinpp', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
  ...
  $(document).off('click', '#waitingnectccrri').on('click', '#waitingnectccrri', function() {
  //sessionStorage.getItem.clear;
...
return false;
 ...
 $(document).off('click', '#shapprovednectccrtyr').on('click', '#shapprovednectccrtyr', function() {
  //sessionStorage.getItem.clear;
...
return false;
      ...
      $(document).off('click', '#completedshnectccrwe').on('click', '#completedshnectccrwe', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
   ...
   $(document).off('click', '#signoutcooineactccrr').on('click', '#signoutcooineactccrr', function() {
...
$('.completedc').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneo+'two');
$('.completedd').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
$('.completedb').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
$('.completeda').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
$('.completede').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
$('.completedf').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 2){
  var oneoo=oneemp[j];
//alert(oneoo+'3');
$('.completeda').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 3){
  var oneooo=oneemp[j];
//alert(oneooo+'4');
$('.completedb').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
$('.completedc').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.completedd').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.completedb').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.completeda').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.completede').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.completedf').append('<img src="http://115.118.113.83/watchguardlive/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
